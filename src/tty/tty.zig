...
pub fn TtyN(comptime history_size: u32) type {
    ...
    return struct {
        ...
        /// Hand the terminal to `pgid`, the group its control characters will
        /// signal. Returns the group it replaces, to give it back afterwards.
